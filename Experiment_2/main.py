...
def get_results_folder(path):
    ...
    File:   input_csvs/flows_48_u_0.8_p201/flows_48_u_0.8_p201_01.csv
              -> Results/flows_48_u_0.8_p201/
    Folder: input_csvs/flows_48_u_0.8_p201/
              -> Results/flows_48_u_0.8_p201/
    """
    ...
    if os.path.isfile(path):
        # Subfolder is the parent directory of the file
        subfolder = parts[-2] if len(parts) >= 2 else ''
    elif os.path.isdir(path):
        # Subfolder is the directory itself
        subfolder = parts[-1]
    else:
        subfolder = ''
